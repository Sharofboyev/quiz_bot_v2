export default {
    ...
    end_level1: "Дорогой Игрок, ",
    end_level2:
        "! \n    🎉Поздравляем! 🎉\n    \n    \n    Вы дошли до финиша, для вас завершился этот Квест. 💪 Мы надеемся, что Квест научил вас чему-то полезному и позволил лучше познакомиться с самим собой. 👍\n    \n    \n    В начале Игры ваш уровень Энергии составлял ",
    end_level3: ". ⚠️\n    Вы пришли к финишу с уровнем Энергии ",
    end_level4:
        ". ✅\n\n\n    🤩 Если ваша Энергия увеличилась, вы можете перейти на следующий уровень Квеста, который будет посвящен вопросам безопасности (физической, финансовой, психологической и др.).\n\n\n    ♻️ Следите за обновлениями Игры в официальном блоге https://www.instagram.com/full_quest_of_life/\n\n\n    🙏 Мы будем благодарны, если вы напишите отзыв об этой Игре по емейлу: full.quest.of.life@gmail.com\n\n\n    Спасибо, что играли с нами! \n    До новых встреч! 👋",
